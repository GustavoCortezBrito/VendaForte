    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-32 text-center">
        ...
        >
          ...
          >
            Grupo Venda Forte soluções completas em empilhadeiras e equipamentos. Oferecemos empilhadeira elétrica, empilhadeira diesel, transpaleteira, paleteira e empilhadeira autônoma. Importação e distribuição de máquinas para movimentação de cargas em todo o Sul do Brasil.
          </motion.p>
