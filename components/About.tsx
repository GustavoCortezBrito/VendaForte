        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-red-50 to-red-100 p-6 rounded-2xl border-l-4 border-red-600"
            >
          ...
          >
            {values.map((value, index) => (
              <motion.div
                ...
                className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all cursor-pointer border border-gray-100 group relative overflow-hidden"
              >
