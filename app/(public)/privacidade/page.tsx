          ...
          >
            ...
            <div className="mb-12">
              ...
              <div className="ml-11 space-y-3 text-gray-600">
                ...
                <p className="mt-4">
                  Para exercer seus direitos, entre em contato conosco através do e-mail: <a href="mailto:comercial@grupovendaforte.com" className="text-red-600 hover:text-red-700 font-semibold">comercial@grupovendaforte.com</a>
                </p>
              </div>
            </div>
